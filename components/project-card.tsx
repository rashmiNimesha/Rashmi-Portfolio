      ...
      >
        ...
        <div className="relative h-full flex flex-col">
          <div className="relative overflow-hidden h-48">
            <div className="absolute inset-0 bg-gradient-to-b from-green-dark/20 to-green-medium/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-10"></div>
            <img
          ...
          <div className="p-6 flex-grow">
            ...
            <div className="flex justify-between mt-auto pt-4 border-t border-zinc-700/50">
              ...
              <Button
                size="sm"
                className="bg-gradient-to-r from-green-dark to-green-medium hover:from-green-medium hover:to-green-dark border-0"
                asChild
              >
