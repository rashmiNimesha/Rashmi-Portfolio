...
export function SkillBadge({ name, level }: SkillBadgeProps) {
  return (
    <motion.div
      ...
      whileHover={{ y: -5 }}
    >
      <div className="relative overflow-hidden rounded-xl bg-zinc-800/50 backdrop-blur-sm border border-zinc-700/50 p-6 h-full transition-all duration-300 hover:border-green-dark/50">
        ...
        <div className="relative">
          ...
          <div className="relative h-2.5 w-full bg-zinc-700 rounded-full overflow-hidden">
            <motion.div
              className="absolute top-0 left-0 h-full bg-gradient-to-r from-green-dark to-green-medium rounded-full"
              initial={{ width: 0 }}
